...
void setup ()
{
  ...
  pinMode (ledpin, 0x1); // Задаем ledpin 13 как интерфейс вывода информации
}
...
{
digitalWrite (ledpin, 0x1); // Включаем светодиод на 13 выходе платы
delay (2000);
digitalWrite (ledpin, 0x0); // Выключаем светодиод на 13 выходе платы
